...
export class Migrations1735140510037 implements MigrationInterface {
    name = 'Migrations1735140510037'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`password\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`password\` varchar(50) NULL DEFAULT 'NULL'`);

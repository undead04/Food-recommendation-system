...
export class Migrations1735198574976 implements MigrationInterface {
    name = 'Migrations1735198574976'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`recipe\` ADD \`imageUrl\` varchar(255) NULL`);

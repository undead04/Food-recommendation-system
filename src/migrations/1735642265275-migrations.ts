...
export class Migrations1735642265275 implements MigrationInterface {
    name = 'Migrations1735642265275'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`isActivate\` \`status\` tinyint NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE \`search_history\` CHANGE \`userId\` \`userId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`rating\` CHANGE \`recipeId\` \`recipeId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`status\` int NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`description\` \`description\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`recipe\` CHANGE \`regionId\` \`regionId\` int NULL`);
        ...
        await queryRunner.query(`CREATE INDEX \`IDX_Rating\` ON \`rating\` (\`recipeId\`, \`userId\`)`);
        await queryRunner.query(`CREATE INDEX \`IDX_GroupRole\` ON \`user\` (\`groupRoleId\`, \`regionId\`)`);
        await queryRunner.query(`CREATE INDEX \`IDX_User_Recipe\` ON \`recipe_user\` (\`userId\`, \`recipeId\`)`);
        await queryRunner.query(`CREATE INDEX \`IDX_Recipe\` ON \`recipe\` (\`regionId\`, \`timeCook\`)`);
        await queryRunner.query(`CREATE FULLTEXT INDEX \`fulltext_index\` ON \`recipe\` (\`name\`, \`description\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_Recipe_Category\` ON \`recipe_category\``);
        await queryRunner.query(`DROP INDEX \`IDX_Recipe_Ingredient\` ON \`recipe_ingredient\``);
        await queryRunner.query(`ALTER TABLE \`recipe\` CHANGE \`regionId\` \`regionId\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`recipe_user\` ADD CONSTRAINT \`FK_f54e802ace39545846bf874e766\` FOREIGN KEY (\`recipeId\`) REFERENCES \`recipe\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`recipe_user\` ADD CONSTRAINT \`FK_72840498f373d843ed1f056639b\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`regionId\` \`regionId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`groupRoleId\` \`groupRoleId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`description\` \`description\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`status\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`status\` tinyint NOT NULL DEFAULT '0'`);
        await queryRunner.query(`CREATE INDEX \`IDX_GroupRole\` ON \`user\` (\`groupRoleId\`, \`regionId\`)`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD CONSTRAINT \`FK_f1a2565b8f2580a146871cf1142\` FOREIGN KEY (\`regionId\`) REFERENCES \`region\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD CONSTRAINT \`FK_88ff32ea732221f2c9ed3818908\` FOREIGN KEY (\`groupRoleId\`) REFERENCES \`group_role\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`rating\` CHANGE \`userId\` \`userId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`rating\` CHANGE \`recipeId\` \`recipeId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`CREATE INDEX \`IDX_Rating\` ON \`rating\` (\`recipeId\`, \`userId\`)`);
        await queryRunner.query(`ALTER TABLE \`rating\` ADD CONSTRAINT \`FK_a6c53dfc89ba3188b389ef29a62\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`rating\` ADD CONSTRAINT \`FK_52e568d130cc658fc17c9dd00ff\` FOREIGN KEY (\`recipeId\`) REFERENCES \`recipe\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`search_history\` CHANGE \`userId\` \`userId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`search_history\` ADD CONSTRAINT \`FK_11fdc5f9da08d75bbab5296bcd5\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`group_role\` CHANGE \`created_at\` \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        ...
        await queryRunner.query(`ALTER TABLE \`recipe_ingredient\` ADD CONSTRAINT \`FK_2879f9317daa26218b5915147e7\` FOREIGN KEY (\`ingredientId\`) REFERENCES \`ingredient\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`recipe_ingredient\` ADD CONSTRAINT \`FK_1ad3257a7350c39854071fba211\` FOREIGN KEY (\`recipeId\`) REFERENCES \`recipe\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`status\` \`isActivate\` tinyint NOT NULL DEFAULT '0'`);
    }
